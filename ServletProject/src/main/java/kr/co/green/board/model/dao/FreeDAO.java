...
//				+ "		WHERE rnum BETWEEN ? AND ?";
	...
	public int boardEnroll(Connection con, String title, String content, String name, String uploadDirectory, String fileName) {
		// 1. 쿼리 작성
...
//			con.close();
	...
	public int boardUpdate(Connection con, String title, String content, int idx) {
		String query = "UPDATE free_board"
				+ "         SET fb_title = ?,"
				+ "				fb_content = ?,"
